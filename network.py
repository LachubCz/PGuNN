"""
file contains class for making neural networks
"""
...
class Network:
    ...
    def make_basic_model(state_size, action_size, learning_rate):
        ...
        model.summary()
        #plot_model(model, to_file='model.pdf', show_shapes=True, show_layer_names=False) #schema of neural net
    ...
    def make_dueling_model(state_size, action_size, learning_rate):
        """
        dueling architecture of neural network
        """
        network_input = Input(shape=(state_size,))
